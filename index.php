            ...
            <div id="main" class="column">
                ...
                <div id="recent-news">
                    ...
                    <div class="post">
                        ...
                        <p> Ramadhan sebentaar lagi.. Pasti nya kita harus mulai nyiapin kue untuk lebaran! Nah Mba punya kabar bagus buat kamu sist.. 
						 Kali ini Mba nyediain edisi spesial Grosir Kue Lebaran dengan harga murah dan tentunya berkualitas. Aneka ragam pilihan kue 
						lebaran bisa kamu dapatin disini! Tanpa berdesakan, tanpa capek, jadi ga' usah takut karena kamu tetep bisa khusyuk ketika menjalankan shaum ramadhan<span class="more"><a href="#">Read more</a></span></p>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p>Biasanya ketika kita bikin kue, kadang kita takut kalau kue yang akan kita buat tersebut menjadi bantat, nah Mbak akan berbagi tips
						ke kamu buat mengantisipasi kue yang bantat, penasaran gimana caranya? yuks simak yuks tipsnya.... 
						1. Pilih tepung terigu yang berkualitas <span class="more"><a href="#">Read more</a></span></p>
                    </div>
...
<form class="gsc-search-box" accept-charset="utf-8"><table cellspacing="0" cellpadding="0" class="gsc-search-box">
<tbody><tr><td class="gsc-input"><input autocomplete="off" type="text" size="10" class=" gsc-input" name="search" title="cari" id="gsc-i-id1" dir="ltr" spellcheck="false" style="outline: none; background-image: url(http://www.google.com/cse/intl/id/images/google_custom_search_watermark.gif); background-color: rgb(255, 255, 255); background-position: 0% 50%; background-repeat: no-repeat no-repeat; "></td><td class="gsc-search-button"><input type="button" value="Cari" class="gsc-search-button" title="cari"></td><td class="gsc-clear-button"><div class="gsc-clear-button" title="hasil akhir">&nbsp;</div></td></tr></tbody></table><table cellspacing="0" cellpadding="0" class="gsc-branding"><tbody><tr><td class="gsc-branding-user-defined"></td><td class="gsc-branding-text"><div class="gsc-branding-text">didukung oleh</div></td><td class="gsc-branding-img"><img src="./bout.php_files/small-logo.png" class="gsc-branding-img"></td></tr></tbody></table></form></div></div>
